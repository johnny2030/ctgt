...
class ChinaCityController extends PluginController{
	...
	public function getProvince(){
		if (IS_AJAX){
			...
			$data = " <option value =''>Province</option> ";
			foreach ($list as $k => $vo) {
				$data .= "<option ";
				if( $pid == $vo['id'] ){
					$data .= " selected ";
				}
				$data .= " value ='" . $vo['name'] . "'>" . $vo['name'] . "</option>";
			}
