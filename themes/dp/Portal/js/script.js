...
var appMaster = {
    ...
    animateScript: function() {
        $('.scrollpoint.sp-effect1').waypoint(function(){$(this).toggleClass('active');$(this).toggleClass('animated fadeInLeft');},{offset:'145%'});
       $('.scrollpoint.sp-effect2').waypoint(function(){$(this).toggleClass('active');$(this).toggleClass('animated fadeInRight');},{offset:'145%'});
       $('.scrollpoint.sp-effect3').waypoint(function(){$(this).toggleClass('active');$(this).toggleClass('animated fadeInDown');},{offset:'145%'});
       $('.scrollpoint.sp-effect4').waypoint(function(){$(this).toggleClass('active');$(this).toggleClass('animated fadeIn');},{offset:'145%'});
       $('.scrollpoint.sp-effect5').waypoint(function(){$(this).toggleClass('active');$(this).toggleClass('animated fadeInUp');},{offset:'145%'});
       $('.scrollpoint.sp-effect6').waypoint(function(){$(this).toggleClass('active');$(this).toggleClass('animated bounceIn');},{offset:'145%'});
    },
    canvasHack: function(){
    ...
    ThemeSwitcher: function(){
        ...
        var blueConfig = function(){
            $('link[title=mainStyle]').attr('href', '__TMPL__Portal/css/styles-blue.css');
        ...
        var orangeConfig = function(){
            $('link[title=mainStyle]').attr('href', '__TMPL__Portal/css/styles-orange.css');
            $('.navbar-brand img').attr('src','img/logo-orange.png');
            $('img.ipad-image').attr('src','img/samples/ipad-or.png');
            $('img.macbook-image').attr('src','img/samples/macbook-or.png');
        }
        var redConfig = function(){
            $('link[title=mainStyle]').attr('href', '__TMPL__Portal/css/styles-red.css');
