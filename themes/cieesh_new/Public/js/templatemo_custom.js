...
jQuery(document).ready(function($){
    ...
    $(".main_menu a.templatemo_homeacademy").click(function(){
		$('#menu-container .academy').fadeOut(1000, function(){
        $('#menu-container .homepage').fadeIn(1000);
	    });
		return false;
	});
    ...
    $(".main_menu a.templatemo_homevisa").click(function(){
		$('#menu-container .visa').fadeOut(1000, function(){
        $('#menu-container .homepage').fadeIn(1000);
	    });
		return false;
	});
